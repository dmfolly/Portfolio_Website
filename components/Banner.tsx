...
const Banner = () => {
  return (
    ...
    >
      ...
      >
        I am a web developer with 3 month of experience in React. I have a
      ...
      <a href="https://github.com/dee-coder" target="_blank">
        <motion.button
          ...
          className="w-52 h-14 text-sm font-titleFont border border-textOrange rounded-md text-textGreen tracking-wide hover:text-textOrange duration-300"
        >
