    ...
    <div className="w-full  h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4">
      <div className="max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between ">
        ...
        <Link href="/">
          ...
          >
            <Image className="w-8" src={favicon} alt="favicon" />
          </motion.div>
        </Link>
        {/* ============ Logo End here ============== */}
        {/* ============ ListItem Start here ======== */}
        <div className="hidden mdl:inline-flex items-center gap-7">
          ...
          <a href="/assets/dede_cv.pdf" target="_blank">
            <motion.button
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.5 }}
              className="px-4 py-2 rounded-md text-textGreen text-[13px] border border-textGreen hover:text-textOrange duration-300"
            >
              Resume
            </motion.button>
          </a>
          ...
          >
            ...
            >
              ...
              <motion.a
                ...
                href="mailto:mdfscho.stu@gmail.com"
              >
